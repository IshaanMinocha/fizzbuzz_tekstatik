...
def identify_hidden_directory_vulnerabilities(json_input):
    ...
    payloads_by_status = {
        ...
        '301': [
            '/admin', '/old', '/backup', '/redirect', '/moved', '/api/v1', '/secure', '/login', '/signin', 'images'
        ],
        '401': [
        ...
        '404': [
            ...
            '/nonexistent', '/void', '/unused', '/api/v1/notfound', 'test', 'uploads', 'login', 'files', 'config'
        ],
        '405': [
...
json_file_path = os.path.join(os.path.dirname(__file__), 'directories.json')
